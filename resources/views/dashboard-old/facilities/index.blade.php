...
@section('btn')
    @can('add facilities')
        @include('dashboard-old.layouts.partials._add_icon',['route'=>'facilities'])
    @endcan
@endsection
@section('content')
                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body card-dashboard">
                                ...
                                <div class="card-content collapse @if(count(request()->except('type')) > 0) show @endif
                                 ">
                                    <div class="card-body card-dashboard">
                                        ...
                                        <div class="row">
                                            @include('dashboard-old.facilities.partials._form_filter')
                                            <div class="col-12">
                                                <button type="submit"
                            ...
                            <div class="row">
                                @include('dashboard-old.facilities.partials._table')
                            </div>
                        </div>
                    </div>
                </div>
