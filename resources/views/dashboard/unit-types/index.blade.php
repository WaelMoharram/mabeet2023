...
@section('title'){!! __('Unit types') !!}@endsection
@section('header')
                                    ...
                                    <div class="card-body card-dashboard">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <a href="{{route('dashboard.unit-types.index')}}" class="  ml-1 btn btn-warning  waves-effect waves-light btn-sm">{{__('Reset filter')}}</a>
                                            </div>
                                        </div>
                                        {!! Form::close() !!}
                                    </div>
