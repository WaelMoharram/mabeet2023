...
<script src="{{asset('assets/dashboard2/resources')}}/app-assets/vendors/js/tables/datatable/datatables.min.js"></script>
<script src="{{asset('assets/dashboard2/resources')}}/app-assets/vendors/js/tables/datatable/datatables.buttons.min.js"></script>
<script src="{{asset('assets/dashboard2/resources')}}/app-assets/vendors/js/tables/datatable/buttons.html5.min.js"></script>
<script src="{{asset('assets/dashboard2/resources')}}/app-assets/vendors/js/tables/datatable/buttons.print.min.js"></script>
<script src="{{asset('assets/dashboard2/resources')}}/app-assets/vendors/js/tables/datatable/buttons.bootstrap.min.js"></script>
<script src="{{asset('assets/dashboard2/resources')}}/app-assets/vendors/js/tables/datatable/datatables.bootstrap4.min.js"></script>
<script src="{{asset('assets/dashboard2/resources')}}/app-assets/vendors/js/pickers/pickadate/picker.js"></script>
<script src="{{asset('assets/dashboard2/resources')}}/app-assets/vendors/js/pickers/pickadate/picker.date.js"></script>
