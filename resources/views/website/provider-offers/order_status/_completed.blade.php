<div class="row mt-5">
    <div class="col-md-3">
        <a href="{{route('offers')}}?status=previous" class="d-block text-dark mt-4 mb-4"> <i
                class="fas fa-arrow-circle-right mx-1 text-dark"></i> {{__('return to orders')}}</a>
        <a href="{{route('chat')}}" class="d-block text-dark mt-4 mb-4"> <img src="{{asset('/')}}asset/images/send-2.png">  {{__('view chats')}} </a>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="box">
                            ...
                            <a href="javascript:;" class="btn btn-completed"><i class="fa fa-check-circle" style="color: #81CC6DFF;"></i> {{__('Completed order')}} </a>
